 ...
 * today.pty as today_pty, today.sky as today_sky, today.wct as today_wct, yesterday.wct as yesterday_wct,
 * minTpr.tmn as tmn, maxTpr.tmx as tmx
 * from CurrentWeather as today
 * inner join CurrentWeather as yesterday on yesterday.gridX = today.gridX AND yesterday.gridY = today.gridY AND yesterday.dateTime = :yesterday+:time
